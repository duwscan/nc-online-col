...
public class EditRoundViewModel : IValidatableObject
{
    ...
    // Programs assigned to this round
    public List<RoundProgramItemViewModel> AssignedPrograms { get; set; } = [];

    // All active programs available for assignment
    public List<ProgramOptionViewModel> AvailablePrograms { get; set; } = [];
...
public class RoundProgramItemViewModel
{
    public Guid Id { get; set; }
